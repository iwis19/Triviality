...
// Layout geometry is purely presentational: it encodes atlas depth and research generation so
// lineage reads as branches, never mathematical distance (docs/plan.md §8.2).
